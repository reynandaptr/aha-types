...
export declare const ResetPasswordRequestSchema: z.ZodObject<{
    body: z.ZodEffects<z.ZodObject<{
        old_password: z.ZodEffects<z.ZodEffects<z.ZodEffects<z.ZodEffects<z.ZodString, string, string>, string, string>, string, string>, string, string>;
        ...
        renew_password: z.ZodEffects<z.ZodEffects<z.ZodEffects<z.ZodEffects<z.ZodString, string, string>, string, string>, string, string>, string, string>;
    }, "strip", z.ZodTypeAny, {
        old_password: string;
        new_password: string;
...
export declare const Oauth2RedirectRequest: z.ZodObject<{
    query: z.ZodObject<{
        code: z.ZodString;
    }, "strip", z.ZodTypeAny, {
        code: string;
